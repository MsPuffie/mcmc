...
describe('mcmc', () => {
  ...
  it('should calculate the distance between two vertices', () => {
    ...
    assert(true, dist === 2);
  }); // Test whether it returns the correct distance if given two vertices
  ...
  });// the length of the output Chain must be shorter as the original Chain since I remove all the duplicate elements and all the elements left are unique
});
